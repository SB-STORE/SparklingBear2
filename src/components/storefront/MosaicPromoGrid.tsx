...
const cells = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1591637333184-19aa84b3e01f?w=800&q=80&auto=format&fit=crop',
    href: '/products?category=helmets',
    className: 'md:col-span-1 md:row-span-2',
  },
  {
    title: 'Riding Gear',
    subtitle: 'Jackets, gloves, boots & pants',
    image: 'https://images.unsplash.com/photo-1600705722908-bab1e61c0b4d?w=800&q=80&auto=format&fit=crop',
    href: '/products?category=riding-gears-luggage',
    className: 'md:col-span-1 md:row-span-1',
  },
  {
    title: 'Aux Lights',
    subtitle: 'Fog lights & LED driving lights',
    image: 'https://images.unsplash.com/photo-1609630875171-b1321377ee65?w=800&q=80&auto=format&fit=crop',
    href: '/products?category=aux-lights',
    className: 'md:col-span-1 md:row-span-1',
  },
  {
    title: 'Bike Protection & Fitments',
    subtitle: 'Crash guards, frame sliders, saddle stays & more',
    image: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=800&q=80&auto=format&fit=crop',
